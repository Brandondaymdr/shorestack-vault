  ...
  return (
    <div className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-3">
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              {plan.highlight && (
                <span className="absolute -top-2.5 left-4 rounded-full bg-emerald-500 px-2.5 py-0.5 text-xs font-semibold text-black">
                  Most Popular
                </span>
              )}
              ...
              <div className="mt-5">
                {isCurrent ? (
                  <button
                    disabled
                    className="w-full rounded-lg border border-gray-700 px-4 py-2.5 text-sm font-medium text-gray-500"
                  >
                    Current Plan
                  </button>
                ) : plan.contactUrl ? (
                  <a
                    ...
                    className="block w-full rounded-lg border border-gray-700 px-4 py-2.5 text-center text-sm font-medium text-gray-300 hover:bg-gray-800"
                  >
                    {plan.cta}
                  </a>
                ) : isDowngrade ? (
                  <button
                    ...
                    className="w-full rounded-lg border border-gray-700 px-4 py-2.5 text-sm font-medium text-gray-300 hover:bg-gray-800"
                  >
                    Manage Billing
                  </button>
      ...
      {(currentPlan === 'individual' || currentPlan === 'team') && (
        <button
          onClick={onManageBilling}
          className="mt-2 text-sm text-gray-400 underline hover:text-gray-300"
        >
